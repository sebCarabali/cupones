                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="number" min="1" max="100" required class="form-control" name="porcentaje_descuento"
                                    id="porcentaje_descuento" placeholder="Número entre 1 y 100" value="{{ $cupon->porcentaje_descuento }}">
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="number" min="1" class="form-control" name="cantidad" id="cantidad"
                                    placeholder="Cupones disponibles" value="{{ $cupon->cantidad }}">
                            </div>
                            <div class="form-group col-md-6">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="date" class="form-control" class="datepicker" name="fecha_caducidad" min="{{ date('Y-m-d') }}"
                                    id="fecha_caducidad" value="{{$cupon->fecha_caducidad}}">
                            </div>
                            <div class="form-group col-md-6">
                                <label for="aliado">Aliado</label>
                                <select name="aliado" id="aliado" class="form-control">
                                    @foreach ($aliados as $aliado)
                                    <option value="{{ $aliado->id }}" @if($aliado->id == $cupon->aliado->id)
                                        selected @endif>
                                        {{ $aliado->nombre }}
                                    </option>
                                    @endforeach
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-12">
                                ...
                                <textarea name="condiciones" id="condiciones" placeholder="Escriba las condiciones de este cupón"
                                    class="form-control" cols="30" rows="10">{{ $cupon->condiciones }}</textarea>
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="form-group col-md-12">
                                ...
                                <textarea name="descripcion" id="descripcion" required cols="30" placeholder="Escribe las condiciones del cupón"
                                    rows="10" class="form-control">{{ $cupon->descripcion }}</textarea>
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="form-group col-md-12">
